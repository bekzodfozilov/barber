...
check_callback = CallbackData('check', 'lan', 'chat_id', 'item_name')
...
def check_markup(lan, chat_id):
    Confirmed = InlineKeyboardMarkup()
    Check_Mark = InlineKeyboardButton(text="✅", callback_data=check_callback.new(lan=lan, chat_id=chat_id, item_name='Check'))
    return Confirmed.add(Check_Mark)
